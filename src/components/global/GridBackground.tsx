...
export default function GridBackground({ gridSize = 45, width = 500, height = 500 }: { gridSize: number; width: number; height: number }) {
	return (
    <Container
			sx={{ position: "absolute", overflow: 'visible', left: "50%", transform: "translateX(-50%)", display: "flex", maxWidth: "800px", width: "100%", height: "fit-content", margin: "auto", justifyContent: "center" }}>
      <Stack
        sx={theme => ({
          minWidth: `${width}px`,
          minHeight: `${height}px`,
