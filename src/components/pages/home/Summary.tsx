import { Stack, Box, Typography, ListItem, AccordionGroup, Chip, Card, List } from "@mui/joy";
...
export default function Education() {
	...
	<Stack component={"section"} sx={{ width: "100%", p: 2, position: "relative" }} my={5}>
		<Box component={"span"} sx={{ display: "inline" }} my={{ xs: 3, md: "initial" }}>
			<Typography component={"span"} level="h1" textAlign={{ xs: "center", md: "end" }}>
				Profile
						...
						<AccordionGroup variant="plain" transition={"250ms"}>
							<CustomAccordion
								...
								<Stack direction={"column"} textAlign={"start"} width={"80%"} mx={"40px"} margin={"start"} display={"grid"} gap={0}>
									<Stack direction={"row"} mb={"15px"} width={"100%"} sx={{ display: "grid", justifyContent: "center", gridTemplateColumns: "repeat(auto-fit, minmax(100px, 0fr))" }} py={2} gap={1}>
