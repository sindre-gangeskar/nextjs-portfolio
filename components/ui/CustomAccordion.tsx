import type { AccordionProps } from "@/lib/definitions";
import {
	Accordion,
	AccordionDetails,
	AccordionSummary,
	...
	return (
		<Accordion
			...
			sx={(theme) => ({
				...
				overflow: "hidden",
				p: 0,
				boxShadow: `0px 0px 7px ${theme.vars.palette.neutral.softBg}`,
			})}
		>
			<AccordionSummary
				sx={{
