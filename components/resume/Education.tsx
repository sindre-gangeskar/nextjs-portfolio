						...
						<CustomAccordion
							...
							<Stack direction={"column"} textAlign={"start"} width={"80%"} mx={"40px"} margin={"start"} display={"grid"} gap={0}>
								<Stack {...style}>
									...
									<Chip {...chipVariants}>REST API</Chip>
									<Chip {...chipVariants}>Jest</Chip>
									<Chip {...chipVariants}>Supertest</Chip>
									<Chip {...chipVariants}>Postman</Chip>
									<Chip {...chipVariants}>GDPR</Chip>
									<Chip {...chipVariants}>Agile</Chip>
									<Chip {...chipVariants}>Scrum</Chip>
