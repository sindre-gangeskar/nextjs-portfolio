"use client";
import { Stack, Container, Typography, StackProps, List, ListItem, Button } from "@mui/joy";
					...
					<List sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, justifyContent: "space-between" }}>
						<ListItem>
							<Stack gap={1} direction={{ xs: "column", md: "row" }}>
								<Button sx={{ textUnderlineOffset: "5px" }} variant="soft" color="neutral" component={"a"} target="_blank" startDecorator={<EmailRounded />} href="mailto:Sindre Gangeskar<contact@sindregangeskar.dev>">
						...
						<ListItem>
							<Typography color="neutral" component={"p"} startDecorator={<LocationCityRounded />} level={"body-sm"}>
								Nannestad, Norway
							</Typography>
						</ListItem>
					</List>
