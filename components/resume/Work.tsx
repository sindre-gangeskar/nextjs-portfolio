			...
			<List>
				<ListItem component={"li"} sx={{ width: "100%" }}>
					<AccordionGroup transition={"300ms"}>
						<CustomAccordion brightBg avatarSrc="https://images.squarespace-cdn.com/content/v1/6182341f7f6bcb4c55b3ddeb/b1b3b9fb-f883-42b9-8201-f14a1cbfa8f2/Logo_Lockup_vertical_Negative_RGB-22.png?format=1500w" color="danger" headerTitle="Kilter AS" subtitle="Jr. Fullstack Developer (Apr 2026 - Present)">
							<Stack {...style}>
							...
							<Stack direction={"column"} textAlign={"start"} width={"80%"} mx={"40px"} margin={"start"} display={"grid"} gap={0}>
								<Typography level="body-sm" sx={{ lineHeight: "1.5rem" }}>
									I contribute in the development of solutions for full-stack web applications and mobile apps utilzing TypeScript, Docker, SQL, Dart, Flutter and more.
								</Typography>
							</Stack>
						</CustomAccordion>
					</AccordionGroup>
