	...
	return (
		<Stack component={"section"} sx={{ mt: 15, textAlign: { xs: "center", md: "end" }, mx: 5 }}>
			...
			<Stack direction={"row"} mt={5} gap={2} sx={{ display: "flex", justifyContent: "center", justifyItems: "center", flexWrap: "wrap", maxWidth: "md", mx: "auto" }}>
				...
				<Skill id="skill" title="Python" url="https://www.python.org/" description="Multi-paradigm programming language with object-oriented capabilities." icon={SiPython} color="neutral"></Skill>
				...
				<Skill id="skill" title="Bun" url="https://bun.sh/" description="Runtime environment which also natively supports TypeScript files. A more modern and efficient all-in-one toolkit replacement for Node.js"
					icon={SiBun}
					color="success"></Skill>
				<Skill id="skill" title="Flask" url="https://flask.palletsprojects.com/en/stable/" description="Lightweight WSGI web application framework for Python" icon={SiFlask} color="success"></Skill>
