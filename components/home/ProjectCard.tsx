import { Card, Typography, Button, Box, CardActions, CardContent } from "@mui/joy";
import { GitHub, StarRounded } from "@mui/icons-material";
import { FaGlobe } from "react-icons/fa6";
import { ProjectCardProps } from "@/lib/definitions";
export default function ProjectCard({ title = "Placeholder title", description = "Placeholder description", stars, url, color = "neutral", isRepo = false, homepage }: ProjectCardProps) {
	return (
		<Card
			variant="outlined"
			color={color}
