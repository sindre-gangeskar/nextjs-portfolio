	...
	return (
		<Stack
			...
			sx={theme => ({
				...
				boxShadow: `0px 0px 8px ${theme.vars.palette.neutral.softBg}`,
				...
				"&::after": {
					...
					padding: "1px",
					background: `radial-gradient(circle at top left, ${theme.vars.palette.neutral.softHoverBg} 50%, transparent)`,
